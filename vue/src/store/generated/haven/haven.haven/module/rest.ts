...
export type HavenMsgDeletePostResponse = object;
 ...
 */
export interface HavenQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryHavenAll
   * @summary Queries a list of Haven items.
   * @request GET:/haven/haven/haven
   */
  queryHavenAll = (
    query?: {
    ...
    this.request<HavenQueryAllHavenResponse, RpcStatus>({
      path: `/haven/haven/haven`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryHaven
   * @summary Queries a Haven by index.
   * @request GET:/haven/haven/haven/{uid}
   */
  queryHaven = (uid: string, params: RequestParams = {}) =>
    this.request<HavenQueryGetHavenResponse, RpcStatus>({
      path: `/haven/haven/haven/${uid}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/haven/haven/params
   */
